import { StyleProp, StyleSheet, Text, TouchableWithoutFeedbackProps, View, ViewProps, ViewStyle } from 'react-native'
import React from 'react'
import Animated, {FadeInUp,FadeOutUp} from 'react-native-reanimated'

interface T_ViewApp extends ViewStyle, TouchableWithoutFeedbackProps {
...
const ViewApp: React.FC<T_ViewApp> = (props) => {
  ...
  return (
    <>
      {props.animated 
        ...
        : <View style={[defaultStyle.block, styleProps, props.styleBox]} {...props}  
            hitSlop={{ top: 10, left: 10, bottom: 10, right: 10 }}>
            {props.children}
        </View>
